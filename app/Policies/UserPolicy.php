...
class UserPolicy
{
    ...
    {
        return $user->hasRole('Super Admin') || $user->can('view-any User');
    }
    ...
    {
        return $user->hasRole('Super Admin') || $user->can('restore User');
    }
    ...
    {
        return $user->hasRole('Super Admin') || $user->can('force-delete User');
    }
}
